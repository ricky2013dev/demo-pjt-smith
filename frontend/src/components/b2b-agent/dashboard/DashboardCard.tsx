...
interface DashboardCardProps {
  ...
  subtitle?: string;
  /** Rendered right after the title block - controls that belong to the title. */
 ...
 * then the panel body.
 */
const DashboardCard: React.FC<DashboardCardProps> = ({ title, icon, subtitle, headerAfterTitle, headerRight, className = '', children }) => (
